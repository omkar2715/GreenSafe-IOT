...
<!--             <li class="autor"><a href="Viewsensordata.jsp"><button class="btn btn-warning"><b>View all Sensor Data</b></button></a></li>
 -->            </ul>
...
<div class="content"></div>
    <div class="container_12">
      ...
      <h1 style="margin-top:30px;margin-left:290px;text-align:center">Vehicle Data</h1>
...
<thead>
 ...
 <%
  try{
	  ...
	  String sql ="select * from vehicle_tbl where semail='"+Id+"'";
...
<tr>
	  ...
	  <td scope="row"><%=rs.getInt(7)%> </td>
	  <td scope="row"><%=rs.getInt(8)%> </td>
	  <td scope="row"><%=rs.getInt(9)%> </td>
	  <td scope="row"><%=rs.getInt(10)%> </td>
 ...
 <div class="content"></div>
    <div class="container_12">
      ...
      <h1 style="margin-top:30px;color:blue;margin-left:290px;text-align:center">Vehicle Sensor Logs</h1>
<table class="table table-bordered table-striped" style="text-align:center;margin-left:200px;background-color:lightgray">
<thead>
  <tr>
    <th scope="col">Id</th>
...
<tr>
	  ...
	  <td scope="row"> <%=rs1.getString(2) %> </td>
       <td scope="row"> <%=rs1.getString(3)%> </td>
	    <td scope="row"> <%=rs1.getString(4)%> </td>
