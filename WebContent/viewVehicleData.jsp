...
<div class="content"></div>
 ...
 <div class="content"></div>
    <div class="container_12">
      ...
      <h1 style="margin-top:30px;color:blue;margin-left:290px;text-align:center">View Vehicle Data</h1>
...
<thead>
 ...
 <%
  try{
	  ...
	  String sql ="select * from vehicle_tbl where semail='"+UserInfo.getEmail()+"'";
...
<tr>
	  ...
	  <td scope="row"><%=rs1.getString(5)%> </td>
	  <td scope="row"><%=rs1.getInt(6)%> </td>
	  <td scope="row"><%=rs1.getInt(7)%> </td>
	  <td scope="row"><%=rs1.getInt(8)%> </td>
	  <td scope="row"><%=rs1.getInt(9)%> </td>
	  <td scope="row"><%=rs1.getString(10)%> </td>
	  <td><a style="color:blue" href="DeleteVehicle.jsp?id=<%=rs1.getInt(1) %>" onclick="return confirm_alert(this);">Delete</a></td>
